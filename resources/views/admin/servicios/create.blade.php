...
<main class="admin-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-primary"><i class="fas fa-plus me-2"></i> Crear Nuevo Servicio</h2>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="categoria" name="categoria" required>
                            ...
                            <option value="Baños" {{ old('categoria') == 'Baños' ? 'selected' : '' }}>Baños</option>
                            <option value="Peluquería" {{ old('categoria') == 'Peluquería' ? 'selected' : '' }}>Peluquería</option>
                            <option value="Tratamientos" {{ old('categoria') == 'Tratamientos' ? 'selected' : '' }}>Tratamientos</option>
                            <option value="Servicios Adicionales" {{ old('categoria') == 'Servicios Adicionales' ? 'selected' : '' }}>Servicios Adicionales</option>
                        </select>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="especie" name="especie" required>
                            ...
                            <option value="Ambos" {{ old('especie') == 'Ambos' ? 'selected' : '' }}>Ambos</option>
                        </select>
                    </div>
                </div>
