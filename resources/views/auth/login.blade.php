...
<body data-welcome="Bienvenido a PetSpa">
    <div class="container">
            ...
            <div class="auth-right">
                <div class="form-container">
                    <div class="form-wrapper active" id="loginForm">
                        ...
                        <form class="auth-form" id="mfaFormElement" method="POST" action="{{ route('login.mfa') }}" hidden>
                            @csrf
                        ...
                        <div class="form-footer">
                            ...
                            <p>
                                <a href="{{ route('intranet.login') }}" class="switch-form">
                                    <i class="fas fa-shield-halved"></i> Acceso Intranet
                                </a>
                            </p>
                        </div>
