...
<aside class="admin-toolbar bg-primary text-white shadow-sm d-flex flex-column pt-4">
    <ul class="nav flex-column px-2">
        ...
        <li class="nav-item mb-2">
            <a href="{{ route('empleado.gestionar.turnos') }}" class="nav-link text-white d-flex align-items-center gap-3 py-3 px-3 rounded hover-effect active">
    ...
    <!-- Título principal fuera del card -->
            ...
            <div class="mt-3">
                <small class="badge bg-primary">
                   Total: <span id="totalRegistros"> {{ $turnos->count() }}</span> registros
                </small>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form id="formEditarTurno" action="{{ route('empleado.turnos.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validarFormularioEdicion()">
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        <div class="mb-3">
