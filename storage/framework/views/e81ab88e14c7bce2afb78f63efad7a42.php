...
<aside class="admin-toolbar bg-primary text-white shadow-sm d-flex flex-column pt-4">
    <ul class="nav flex-column px-2">
        ...
        <li class="nav-item mb-2">
            <a href="<?php echo e(route('empleado.bandeja.reservas')); ?>" 
        ...
        <li class="nav-item mb-2">
            <a href="<?php echo e(route('empleado.gestionar.turnos')); ?>" 
               class="nav-link text-white d-flex align-items-center gap-3 py-3 px-3 rounded hover-effect">
        ...
        <li class="nav-item mb-2">
            <a href="<?php echo e(route('empleado.gestionar.novedades')); ?>" 
               class="nav-link text-white d-flex align-items-center gap-3 py-3 px-3 rounded hover-effect">
        ...
        <!-- ESTA ES LA ACTIVA -->
        <li class="nav-item mb-2">
            <a href="<?php echo e(route('empleado.notificaciones')); ?>" 
...
<div class="card shadow-sm border border-1 mb-4">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('empleado.notificaciones.custom')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="col-md-6">
                    ...
                    <select name="usuarios[]" class="form-select" multiple required>
                        <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($u->correo); ?>">
                                <?php echo e($u->correo); ?> (ID: <?php echo e($u->id_usuario); ?>)
                            </option>
        ...
        <td>
            <div class="form-check form-switch d-flex justify-content-center">
                <input class="form-check-input" type="checkbox"
                    onchange="cambiarEstado(<?php echo e($n->id_notificacion); ?>)"
                    <?php echo e($n->estado == 'A' ? 'checked' : ''); ?>>
            </div>
        </td>
        ...
        <td class="text-center">
            ...
            <button class="btn btn-outline-primary btn-sm me-1"
                onclick="editarNotificacion(
                    <?php echo e($n->id_notificacion); ?>,
                    '<?php echo e($n->tipo); ?>',
                    '<?php echo e(addslashes($n->mensaje)); ?>',
                    '<?php echo e($n->fecha_envio); ?>',
                    '<?php echo e($n->estado); ?>'
                )">
                <i class="fas fa-edit"></i>
            </button>

            <form action="<?php echo e(route('empleado.notificaciones.ejecutar', $n->id_notificacion)); ?>" 
...
<?php endif; ?>
                ...
                <div class="mt-3">
                    <small class="badge bg-primary">Total: <?php echo e($notificaciones->count()); ?> registros</small>
                </div>
            </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-body">
            ...
            <form action="<?php echo e(route('empleado.notificaciones.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-body">
            ...
            <form action="<?php echo e(route('empleado.notificaciones.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ProyectoSpa\Estetica-canina\resources\views/empleado/notificaciones.blade.php ENDPATH**/ ?>