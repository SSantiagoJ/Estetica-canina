            ...
            <div class="card shadow-sm p-3">
                ...
                <div class="row">
                    <?php $__currentLoopData = $servicios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 mb-3">
                            <div class="card border-0 shadow-sm h-100">
                                <img src="<?php echo e(asset('img/servicios/'.$s->imagen_referencial)); ?>" class="card-img-top" alt="<?php echo e($s->nombre_servicio); ?>">
                                <div class="card-body">
                    ...
                    <?php $__currentLoopData = $adicionales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 mb-3">
                            <div class="card border-0 shadow-sm h-100">
                                <img src="<?php echo e(asset('img/servicios/'.$a->imagen_referencial)); ?>" class="card-img-top" alt="<?php echo e($a->nombre_servicio); ?>">
                                <div class="card-body">
            ...
            return actions.order.create({
                purchase_units: [{
                    ...
                    amount:{
                        ...
                        value:"<?php echo e(number_format($total / 3.80, 2, '.', '')); ?>"
                        }
                }]
            });
        },
