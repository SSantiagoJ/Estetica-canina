        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                <button type="button" class="btn btn-primary"
                        ...
                        data-bs-target="#modalRegistrarNotificacion">
    ...
    <tr class="align-middle">
        ...
        <td class="text-center">
            ...
            <button class="btn btn-warning btn-sm"
                onclick="confirmarPrueba(<?php echo e($n->id_notificacion); ?>)">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ProyectoSpa\Estetica-canina\resources\views/empleado/gestionar-notificaciones.blade.php ENDPATH**/ ?>