<?php $__env->startSection('title', 'Gestionar Novedades - Estética Canina'); ?>
...
<aside class="admin-toolbar bg-primary text-white shadow-sm d-flex flex-column pt-4">
    <ul class="nav flex-column px-2">
        ...
        <!-- Marcar como activo -->
        <li class="nav-item mb-2">
            <a href="<?php echo e(route('empleado.gestionar.novedades')); ?>" class="nav-link text-white d-flex align-items-center gap-3 py-3 px-3 rounded hover-effect active">
            ...
            <div class="table-section">
                        ...
                        <tbody id="tablaNovedades">
                            <?php $__empty_1 = true; $__currentLoopData = $novedades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $novedad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e(\Carbon\Carbon::parse($novedad->fecha_publicacion)->format('d/m/Y')); ?></td>
                                    <td><?php echo e($novedad->categoria); ?></td>
                                    <td>
                                        <?php if($novedad->estado == 'B'): ?>
                                            <span class="badge bg-warning">BORRADOR</span>
                                        <?php elseif($novedad->estado == 'P'): ?>
                                    ...
                                    <td>
                                        <button class="btn btn-outline-primary btn-sm" 
                                            onclick="editarNovedad(
                                                <?php echo e($novedad->id_novedades); ?>, 
                                                '<?php echo e(addslashes($novedad->titulo)); ?>', 
                                                '<?php echo e(addslashes($novedad->resumen)); ?>', 
                                                '<?php echo e(addslashes($novedad->descripcion)); ?>', 
                                                '<?php echo e($novedad->categoria); ?>', 
                                                '<?php echo e($novedad->fecha_publicacion->format('Y-m-d')); ?>', 
                                                '<?php echo e($novedad->estado); ?>'
                                            )">
                ...
                <!-- Contador de registros con mejor espaciado -->
                        <div class="mt-3">
                             ...
                             Total: <span id="totalRegistros"> <?php echo e($novedades->count()); ?></span> registros
                             </small>
                        </div>
                    </div>
                 </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
            <div class="modal-body">
                ...
                <form action="<?php echo e(route('empleado.novedades.store')); ?>" method="POST" enctype="multipart/form-data" id="formRegistrarNovedad" onsubmit="return validarFormularioRegistrar()">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
       <div class="modal-content">
            <div class="modal-body">
                ...
                <form  action="<?php echo e(route('empleado.novedades.store')); ?>" method="POST" enctype="multipart/form-data" id="formEditarNovedad" onsubmit="return validarFormularioEditar()">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ProyectoSpa\Estetica-canina\resources\views/empleado/gestionar-novedades.blade.php ENDPATH**/ ?>